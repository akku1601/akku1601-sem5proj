...
?>
 ...
 <div class="card" style="width:100%; border-color: pink; border-width: 15px;">
  <img class="card-img-top" src="https://media3.giphy.com/media/KEjeb7VbJStJmVyT66/giphy.gif" alt="Card image" height="380px" >
</div>
<br>
...
<main role="main" class="container">
  <div class="row">
    <div class="col-md-8 blog-main">
      <h3 class="pb-4 mb-4 font-italic bg-light text-muted">FOCUS on Positive's</h3>
      <hr>
