...
?>
 ...
 <div class="card" style="width:100%;">
  <img class="card-img-top" src="https://freerangestock.com/sample/119412/search-for-apartment-.jpg" alt="Card image" height="380px" >
</div>
<br>
   ...
   <aside class="col-md-4 blog-sidebar">
     ...
     <!--Covid-19 blog start-->
      <div class="p-4 my-5 mx-3 bg-light rounded w-100">
        ...
        <br>
        <p class="p-2 text-success">To know more <a href="https://www.who.int/"><em>visit here</em></a></p>
      </div>
<!--Covid-19 blog end-->
      <br><br><br>
